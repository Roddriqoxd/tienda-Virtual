...
if (!empty($_SESSION['active'])) {
    ...
    if (!empty($_POST)) {
        ...
        if (empty($_POST['usuario']) || empty($_POST['clave'])) {
            ...
            $clave = mysqli_real_escape_string($conexion, $_POST['clave']); //md5(mysqli_real_escape_string($conexion, $_POST['clave']))
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Toji online store</h1>
