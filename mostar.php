...
<div id="diver" style="text-align:center;" class="mx-3">
        ...
        <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#exampleModal">
            <img  data-bs-toggle="modal" data-bs-target="#exampleModal" class="img-thumbnail" src="assets/img/<?php echo $data['imagen4']; ?>" width="100" />
        </button>
...
<!-- numero 2 -->
        <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#exampleModal">
            <img  data-bs-toggle="modal" data-bs-target="#exampleModal" class="img-thumbnail" src="assets/img/<?php echo $data['imagen3']; ?>" width="100" />
        </button>
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
...
<!-- numero 2 -->
        <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#exampleModal">
            <img  data-bs-toggle="modal" data-bs-target="#exampleModal" class="img-thumbnail" src="assets/img/<?php echo $data['imagen2']; ?>" width="100" />
        </button>
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
